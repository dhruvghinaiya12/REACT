    ...
    <nav className="bg-gray-900 p-4">
      ...
      <div className="md:hidden peer-checked:block bg-gray-800 text-white p-4 hidden">
        ...
        {user ? (
          ...
          <Link to="/signup" className="text-white hover:text-gray-400 transition-colors cursor-pointer">
            Sign Up
          </Link>
        )}
        {user ? (
          <span className="text-white hover:text-gray-400 transition-colors cursor-pointer" onClick={logout}>
            Logout
          </span>
        ) : (
          <Link to="/login" className="text-white hover:text-gray-400 transition-colors">
